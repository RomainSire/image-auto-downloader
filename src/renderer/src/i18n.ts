...
const dict: Record<Lang, Dict> = {
  en: {
    ...
    'settings.defaultDest': 'Default destination folder',
    ...
    'download.doneWithErrors': '{total} image(s) downloaded — {failed} source(s) failed.',
    'download.doneOk': '✓ {total} image(s) downloaded to {path}',
  ...
  fr: {
    ...
    'settings.defaultDest': 'Dossier de destination par défaut',
    ...
    'download.doneWithErrors': '{total} image(s) téléchargée(s) — {failed} source(s) en erreur.',
    'download.doneOk': '✓ {total} image(s) téléchargée(s) dans {path}',
  ...
  ja: {
    ...
    'settings.defaultDest': 'デフォルトの保存先フォルダー',
    ...
    'download.doneWithErrors': '{total} 枚をダウンロード — {failed} 個のソースでエラー。',
    'download.doneOk': '✓ {total} 枚を {path} にダウンロードしました',
